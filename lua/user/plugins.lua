...
return packer.startup(function(use)
  ...
  use { "kyazdani42/nvim-tree.lua", commit = "0cd8ac4751c39440a1c28c6be4704f3597807d29" }
  ...
  use { "neovim/nvim-lspconfig", commit = "6eb24ef9175d1fa3c7a23e115854b1a2d923d386" } -- enable LSP
  use { "williamboman/mason.nvim", commit = "e8bf53119572622f9c45c82f4ef9443a4d37df4b" }
